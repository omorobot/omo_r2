...
def generate_launch_description():
    cartographer_dir = get_package_share_directory('omo_r2_cartographer')

    configuration_basename = LaunchConfiguration('configuration_basename', default=os.environ['ROBOT_MODEL'] + '.lua')
